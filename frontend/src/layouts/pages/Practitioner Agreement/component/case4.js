                    ...
                    <Grid item xs={12} sm={4} >
                        <FormControlLabel
                            ...
                            control={
                                <Checkbox
                                    className="stylebox"
                                    checked={values.practitioner_agreement_flagPage4}
                                    name="practitioner_agreement_flagPage4"
                                    // onChange={handleChange}
                                    onChange={(e) => setFieldValue("practitioner_agreement_flagPage4",e.target.checked)}
