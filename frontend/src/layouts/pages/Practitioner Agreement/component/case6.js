                ...
                <Grid container spacing={2}>
                    <Grid item xs={12} lg={6} >
                        ...
                        <Grid container spacing={5}>
                            <Grid item xs={12} sm={4} md={6} className="spaceing">
                                <FormField
                                    label="Print Name"
                        ...
                        <div>
                            <Grid container spacing={5}>
                                <Grid item xs={12} md={6} sm={4} className="spaceing">
                                    <FormField
                                        label="Date"
                                        type="date"
                                        placeholder="date"
                            ...
                            <Grid container spacing={5}>
                                <Grid item xs={12} md={6} sm={4} className="spaceing">
                                    <FormField
                                        ...
                                        onChange={handleChange}
                                        errorMsg
                                        error={errors.practitioner_aggrement_date && touched.practitioner_aggrement_date}
                                        //success={values?.practitioner_aggrement_date?.length > 0 && !errors.practitioner_aggrement_date}
                                    />
                                </Grid>
                            </Grid>
                        </div>
                            ...
                            <FormControlLabel
                                ...
                                control={
                                    <Checkbox
                                        ...
                                        // onChange={handleChange}
                                    onChange={(e) => setFieldValue("practitioner_agreement_flag",e.target.checked)}
                                    />
                                }
                                label={"I Agree"}
                            />
