...
const Case2 = ({ handleChange, touched, errors, setFieldValue }) => {
        ...
        <Grid container spacing={0} style={{ alignItems: "center" }}>
          ...
          <Grid item xs={8} sm={4} lg={2} mb={2} className="setInitalName">
            <FormField
              ...
              value={userdata?.informed_Retroactive_initial}
              disabled="true"
        ...
        <Grid container spacing={5}> */}
          ...
          <Grid item xs={12} sm={4} className="spaceing">
            <FormField
              ...
              value={userdata?.informed_consent_date}
              disabled="true"
              //   onChange={handleChange}
            />
          </Grid>
          ...
          {userdata.Informed_sign_client !== undefined ? (
            <Grid item xs={12} sm={4} className="parentClass">
              <h5 style={{ fontSize: "13px" }}>Sign</h5>
              <img src={userdata.Informed_sign_client} />
