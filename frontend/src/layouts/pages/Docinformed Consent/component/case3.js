...
const Case3 = ({ handleChange, touched, errors, setFieldValue }) => {
      ...
      <SoftBox px={3} mt={5} py={1} mb={1}>
        <Grid container justifyContent="center" sx={{ height: "50%" }} item xs={12} lg={12}>
          <Stack direction={"column"}>
            <h2 className="color">TERMS AND CONDITIONS</h2>
          </Stack>
        </Grid>
      </SoftBox>
...
<br/>
         <p> Travel Clinic appointments involve some unique variables for consideration due to
          ...
          questions or concerns regarding this Travel Clinic Change and Cancellation Policy.</p>
          {/* </b> */}
          <br />
          <br />
          <u>
        ...
        <Grid container spacing={0} style={{ alignItems: "center", marginBottom: "-15px" }}>
          ...
          <Grid item xs={8} sm={4} lg={2} mb={2} className="setInitalName">
            <FormField
              ...
              value={userdata.terms_Retroactive_initial}
              disabled="true"
          ...
          <Grid container spacing={1} style={{ alignItems: "center" }} direction={"row"}>
            ...
            <Grid item xs={6} sm={4} lg={2} mb={2} className="setInitalName">
              <FormField
                ...
                value={userdata.practitionerLicenceType}
                disabled="true"
                // onChange={handleChange}
        ...
        <Grid container spacing={5}>
          <Grid item xs={12} sm={4} className="parentClass">
            <FormField
              type="number"
              label="Resting Heart Rate (RHR) in beats per minute"
              // style={{ fontFamily: "Rage italic",fontVariant: "small-caps",fontSize : "20px !important"}}
          ...
          <Grid item xs={12} sm={4} className="parentClass">
            <FormField
              label="Respiratory Rate (RR) in breaths per minute "
              type="number"
          ...
          <Grid item xs={12} sm={4} className="parentClass">
            <FormField
              label="Body Temperature in degrees Fahrenheit "
              type="number"
              name="Body_temp"
      ...
      <SoftBox component="form" px={10} className="nameAndDate">
        <Grid container spacing={5}>
          <Grid item xs={12} sm={12} lg={4} className="name">
            <FormField
        ...
        <Grid container spacing={5}>
          {userdata.term_page_sign_client !== undefined ? (
            <Grid item xs={12} sm={12} lg={4} className="name">
              <FormField
                ...
                placeholder="date"
                name="TermsAndSignature_client__date"
                value={userdata.TermsAndSignature_client__date}
                disabled="true"
                //   onChange={handleChange}
              />
              <h5 style={{ fontSize: "13px" }}>Client Sign</h5>
              <img src={userdata.term_page_sign_client} />
              <h5 style={{ fontSize: "13px" }}>Sign here</h5>
            </Grid>
          ) : (
            <Grid item xs={12} sm={12} md={6} lg={4} className="name">
              <FormField
                label={<span style={{ fontSize: "15px" }}>Date</span>}
                type="date"
                placeholder="date"
          ...
          {/* <Grid item xs={12} sm={4} className="spaceing"> */}
          {userdata.term_page_sign_ofc !== undefined ? (
            <Grid item xs={12} sm={4} className="parentClass">
              <FormField
                label={<span style={{ fontSize: "15px" }}>Date</span>}
                type="date"
                ...
                name="TermsAndSignature_ofc_date"
                disabled="true"
                value={userdata.TermsAndSignature_ofc_date}
                //   onChange={handleChange}
              />
              <h5 style={{ fontSize: "13px" }}>Office Sign</h5>
              <img src={userdata.term_page_sign_ofc} />
              <h5 style={{ fontSize: "13px" }}>Sign here</h5>
            </Grid>
          ) : (
