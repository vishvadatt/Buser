...
const Case4 = ({ handleChange, touched, errors, setFieldValue }) => {
  ...
  return (
    <div>
        ...
        <Grid container spacing={0} style={{ alignItems: "center" }}>
          ...
          <Grid item xs={8} sm={4} lg={2} mb={2} className="setInitalName">
            <FormField
              ...
              value={userdata.arbitraion_Retroactive_initial}
              disabled="true"
      ...
      <SoftBox component="form" px={10} className="nameAndDate">
        ...
        <Grid container spacing={5}>
          {userdata.ARBITRATION_sign_client !== undefined ? (
            <Grid item xs={12} sm={12} lg={4} className="name">
              <FormField
                ...
                placeholder="date"
                name="arbitraion_client__date"
                value={userdata.arbitraion_client__date}
                disabled="true"
                //   onChange={handleChange}
              />
              <h5 style={{ fontSize: "13px" }}>Client Sign</h5>
              <img src={userdata.ARBITRATION_sign_client} />
          ...
          {/* <Grid item xs={12} sm={4} className="spaceing"> */}
          {userdata.ARBITRATION_sign_ofc !== undefined ? (
            <Grid item xs={12} sm={4} className="parentClass">
              <FormField
                ...
                placeholder="date"
                name="arbitraion_ofc_date"
                value={userdata.arbitraion_ofc_date}
                disabled="true"
                //   onChange={handleChange}
              />
              <h5 style={{ fontSize: "13px" }}>Office Sign</h5>
              <img src={userdata.ARBITRATION_sign_ofc} />
              <h5 style={{ fontSize: "13px" }}>Sign here</h5>
            </Grid>
          ) : (
            <Grid item xs={12} md={6} lg={4}>
              ...
              />
              <div className="saveAndClear">
                <SoftButton onClick={clear} disabled={signBeginOfc} style={{ marginRight: "10px" }}>
                  Clear
                </SoftButton>
