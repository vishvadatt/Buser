  ...
  return (
    <div>
      <SoftBox px={3} mt={5} py={1} mb={1}>
        ...
        <SoftBox px={3} mt={5} py={1} mb={1}>
          {/* <Grid container sx={{ height: "50%" }} item xs={12} lg={12}> */}
          <Typography variant="h2" textAlign={"center"} >THE BUSER INSTITUTE</Typography>
          <Typography variant="h2" textAlign={"center"} >STUDENT,</Typography>
          <Typography variant="h2" textAlign={"center"} >INDEPENDENT PRACTITIONER,</Typography>
          <Typography variant="h2" textAlign={"center"} >ASSOCIATE PRACTITIONER (INDEPENDENT CONTRACTOR)</Typography>
          <Typography variant="h2" textAlign={"center"} >AGREEMENT</Typography>
          {/* <h2  style={{textAlign: "center", color: "rgb(52, 71, 103)"}}>THE BUSER INSTITUTE STUDENT INDEPENDENT PRACTITIONER CERTIFIED PRACTITIONER AGREEMENT</h2> */}
          {/* </Grid> */}
        </SoftBox>
      </SoftBox>
