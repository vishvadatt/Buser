...
function index({ formData, stepIndex, setActiveStep }) {
  ...
  const clientIntakeformDetails = useSelector((state) => state.auth.clientIntakeForm?.page26);
  ...
  const initialValue26 = clientIntakeformDetails
    ? clientIntakeformDetails
    : [{ ...initialValue.page26[0] }];
                ...
                <Grid>
                  <FieldArray
                    ...
                    render={(arrayhelpers, push) => {
                      return (
                        <>
                          {formik.values.page26.map((page, index) => (
                            <Grid key={index}>
                              {index > 0 && (
                          ...
                          >
                            <SoftButton
                              ...
                              onClick={() =>
                                arrayhelpers.insert(
                                  formik?.values?.page26?.length,
                                  formik.values.page26[formik.values.page26.length - 1]
                                )
                              }
                            >
                              Add new Page
