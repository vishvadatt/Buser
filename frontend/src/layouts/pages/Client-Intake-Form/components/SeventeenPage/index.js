...
function index({ formData, stepIndex, setActiveStep }) {
  ...
  const clientIntakeformDetails = useSelector((state) => state.auth.clientIntakeForm?.page21);
  ...
  const initialValue21 = clientIntakeformDetails
    ? clientIntakeformDetails
    : [{ ...initialValue.page21[0] }];
  ...
  return (
    <>
      <SoftBox>
        <Formik
          initialValues={{
            page21: [...initialValue21],
          }}
          enableReinitialize
          onSubmit={(values) => {
            const page1Object = { ...page10Data, ...values };
            const data = {
              patientId: UserId,
              page21: values.page21,
            };
                ...
                <Grid>
                  <FieldArray
                    ...
                    render={(arrayhelpers, push) => {
                      return (
                        <>
                          {formik.values.page21.map((page, index) => (
                            <Grid key={index}>
                              {index > 0 && (
                          ...
                          >
                            <SoftButton
                              ...
                              onClick={() =>
                                arrayhelpers.insert(
                                  formik?.values?.page21?.length,
                                  formik.values.page21[formik.values.page21.length - 1]
                                )
                              }
                            >
                              Add new Page
