...
function firstPart({ formik, index }) {
  const { values } = formik;
  const { name: nameV, gender: genderV, age: ageV, date: dateV } = values.page27[index];
  return (
    <>
      <SoftBox mt={1}>
        <Grid container>
