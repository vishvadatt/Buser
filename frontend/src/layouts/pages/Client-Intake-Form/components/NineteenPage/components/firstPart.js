...
function firstPart({ formik, index }) {
  const { values } = formik;
  const { age: ageV, date: dateV, name: nameV, gender: genderV } = values.page23[index];
  return (
    <>
      <SoftBox mt={1}>
        <Grid container>
