...
function index({ formData, stepIndex, setActiveStep }) {
  ...
  const clientIntakeformDetails = useSelector((state) => state.auth.clientIntakeForm?.page23);
  ...
  const initialValue23 = clientIntakeformDetails
    ? clientIntakeformDetails
    : patientIntakeFormDetail.shouldShowPatientIntakeFormDetail
    ? [{ ...initialValue.page23[0] }]
    : [{ ...initialValue.page23[0], ...personalInformation }];
                ...
                <Grid>
                  <FieldArray
                    ...
                    render={(arrayhelpers, push) => {
                      return (
                        <>
                          {formik.values.page23.map((page, index) => (
                            <Grid key={index}>
                              {index > 0 && (
                          ...
                          >
                            <SoftButton
                              ...
                              onClick={() =>
                                arrayhelpers.insert(
                                  formik?.values?.page23?.length,
                                  formik.values.page23[formik.values.page23.length - 1]
                                )
                              }
                            >
                              Add new Page
