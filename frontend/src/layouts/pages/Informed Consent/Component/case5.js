...
const Case5 = ({ values, handleChange, touched, errors, setFieldValue }) => {
  ...
  useEffect(() => {
    ...
    if (!values.client_signature_date)
      setFieldValue("client_signature_date", getDefaultClientSignatureDateValue());

    if (!values.office_signature_date) {
      setFieldValue("office_signature_date", getDefaultClientSignatureDateValue());
    }
  }, []);
  ...
  return (
    <div>
        ...
        <Grid container spacing={0} style={{ alignItems: "center" }}>
          ...
          <Grid item xs={8} sm={4} lg={2} mb={2} className="setInitalName">
            <FormField
              ...
              value={values.commitment_initial1}
              onChange={handleChange}
              error={errors.commitment_initial1 && touched.commitment_initial1}
              success={values?.commitment_initial1?.length > 0 && !errors.commitment_initial1}
            />
          </Grid>
        </Grid>
        <p style={{ marginBottom: "-26px", textAlign: "justify" }} className="initialhere">
        <h6>Your Participation Consent and Release: </h6>I consent to the use of my non-confidential, clinically relevant information (including
        ...
        <Grid container spacing={0} style={{ alignItems: "center" }}>
          ...
          <Grid item xs={8} sm={4} lg={2} mb={2} className="setInitalName">
            <FormField
              ...
              value={values.commitment_initial2}
              onChange={handleChange}
              error={errors.commitment_initial2 && touched.commitment_initial2}
              success={values?.commitment_initial2?.length > 0 && !errors.commitment_initial2}
            />
          </Grid>
        </Grid>
        ...
        <Grid container spacing={0} className="newCommitment_initial3">
          ...
          <Grid item xs={8} sm={4} lg={2} mb={2} className="setInitalName">
            <FormField
              ...
              value={values.newCommitment_initial3}
              onChange={handleChange}
              error={errors.newCommitment_initial3 && touched.newCommitment_initial3}
              success={values?.newCommitment_initial3?.length > 0 && !errors.newCommitment_initial3}
            />
          </Grid>
        </Grid>
        ...
        <Grid container spacing={0} style={{ alignItems: "center", marginBottom: "-15px" }}>
          ...
          <Grid item xs={8} sm={4} lg={2} mb={2} className="setInitalName">
            <FormField
              ...
              value={values.client_Retroactive_initial}
              onChange={handleChange}
              error={errors.client_Retroactive_initial && touched.client_Retroactive_initial}
              success={
                values?.client_Retroactive_initial?.length > 0 && !errors.client_Retroactive_initial
              }
            />
          </Grid>
      ...
      <SoftBox component="form" px={10} className="nameAndDate" style={{ fontSize: "15px" }}>
        ...
        <Grid container spacing={5}>
          {values.agrrement_sign_client !== undefined ? (
            <Grid item xs={12} sm={6} className="parentClass">
              ...
              <img src={values.agrrement_sign_client} />
          ...
          {values.agrrement_sign_ofc !== undefined ? (
            <Grid item xs={12} sm={6} className="parentClass">
              <FormField
                label={<span style={{ fontSize: "15px" }}>Date</span>}
                type="date"
              ...
              <img src={values.agrrement_sign_ofc} />
              <h5 style={{ fontSize: "15px" }}>Sign here</h5>
            </Grid>
          ) : (
            <Grid item xs={12} sm={6}>
          ...
          <Grid item xs={12} sm={4}>
            <FormControlLabel
              ...
              control={
                <Checkbox
                  className="stylebox"
                  defaultChecked={values.agrrement_flag}
                  name="agrrement_flag"
                  // onChange={handleChange}
                  onChange={(e) => setFieldValue("agrrement_flag",e.target.checked)}
                />
              }
              label={"I Agree"}
            />
