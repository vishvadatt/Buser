          ...
          <Grid container mt={1}>
            ...
            <Grid item lg={2} md={4} className="pain-time">
              <input
                type="text"
                value={neckpainyearV}
                name={`Intake14[${index}].neckpainyear`}
                onChange={formik.handleChange}
              />
            ...
            <Grid item lg={2} md={4} className="pain-time">
              <input
                ...
                name={`Intake14[${index}].neckpainmonth`}
                onChange={formik.handleChange}
              />
            ...
            <Grid item lg={2} md={4} className="pain-time">
              <input
                type="text"
                value={neckpainweekV}
                name={`Intake14[${index}].neckpainweek`}
                onChange={formik.handleChange}
              />
          ...
          <Grid container>
            ...
            <Grid item lg={2} md={4} className="pain-time">
              <input
                type="text"
                value={backpainyearV}
                name={`Intake14[${index}].backpainyear`}
                onChange={formik.handleChange}
              />
              <span style={{ fontSize: "15px", marginLeft: "5px" }}>years</span>
            </Grid>
            <Grid item lg={2} md={4} className="pain-time">
              <input
                ...
                name={`Intake14[${index}].backpainmonth`}
                onChange={formik.handleChange}
              />
              <span style={{ fontSize: "15px", marginLeft: "5px" }}>months</span>
            </Grid>
            <Grid item lg={2} md={4} className="pain-time">
              <input
                type="text"
                value={backpainweekV}
                name={`Intake14[${index}].backpainweek`}
                onChange={formik.handleChange}
              />
              <span style={{ fontSize: "15px", marginLeft: "5px" }}>weeks</span>
            </Grid>
