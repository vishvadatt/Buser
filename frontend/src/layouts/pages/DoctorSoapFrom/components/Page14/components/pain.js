...
function Pain({ form, stepIndex, formik,page8 }) {
    const { values } = formik
    const orthopadic = values?.orthopadik
    ...
    const pain = page8?.orthopedic;
    const pain1 = page8?.neurological;
    const pain2 = page8?.injuries;
    const pain3 = page8?.brain;
                ...
                !!check1 && check1.length > 0 ?
                    <>
                        <div>
                            ...
                            {
                                !!check1 && check1.map((data, i) => {
                                    const value = !!orthopadic && Object.keys(orthopadic).filter((keyName) => keyName === data.name)
                ...
                !!check2 && check2.length > 0 ?
                    <>
                        <div>
                            ...
                            {
                                !!check2 && check2.map((data, i) => {
                                    const value = !!neurological && Object.keys(neurological).filter((keyName) => keyName === data.name)
                                    console.log("valueaaaa", value)
                                    return (
                                        <>
                                            <Grid container className="conditions">
                ...
                !!check3 && check3.length > 0 ?
                    <>
                        <div>
                            ...
                            {
                                !!check3 && check3.map((data, i) => {
                                    const value = !!injuries && Object.keys(injuries).filter((keyName) => keyName === data.name)
                                    console.log("valueaaaa", value)
                                    return (
                                        <>
                                            <Grid container className="conditions">
                ...
                !!check4 && check4.length > 0 ?
                    <>
                        <div>
                            ...
                            {
                                !!check4 && check4.map((data, i) => {
                                    const value = !!brain && Object.keys(brain).filter((keyName) => keyName === data.name)
                                    console.log("valueaaaa", value)
                                    return (
                                        <>
                                            <Grid container className="conditions">
...
Pain.propTypes = {
    ...
    page8 : PropTypes.oneOfType([PropTypes.object, PropTypes.func]).isRequired,
};
export default Pain