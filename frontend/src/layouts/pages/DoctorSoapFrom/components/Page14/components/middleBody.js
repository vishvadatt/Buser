    ...
    <>
      <SoftBox>
        <div className="container">
          ...
          <div className="middlefirsticon1 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirstone`}
          ...
          <div className="middlefirsticon2 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirsttwo`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon3 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirstthree`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon4 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirstfour`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon5 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirstfive`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon6 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirstsix`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon7 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirstseven`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon8 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirsteight`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon9 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirstnine`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon10 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirstten`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon11 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirsteleven`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon12 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirsttwleve`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon13 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirstthirteen`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon14 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirstfourteen`}
              onChange={formik.handleChange}
          ...
          <div className="middlefirsticon15 round-check">
            <Checkbox
              name={`Intake14[${index}].middlefirstfifteen`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon1 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondone`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon2 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondtwo`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon3 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondthree`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon4 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondfour`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon5 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondfive`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon6 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondsix`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon7 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondseven`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon8 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondeight`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon9 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondnine`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon10 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondten`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon11 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondeleven`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon12 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondtwleve`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon13 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondthirteen`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon14 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondfourteen`}
              onChange={formik.handleChange}
          ...
          <div className="middlesecondicon15 round-check">
            <Checkbox
              name={`Intake14[${index}].middlesecondfifteen`}
              onChange={formik.handleChange}
